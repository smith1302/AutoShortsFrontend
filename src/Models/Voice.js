export default class Voice {
    ...
    static all() {
        ...
        // ]
        return [
            new Voice('alloy', 'Alloy', 'https://cdn.openai.com/API/docs/audio/alloy.wav'),
            new Voice('echo', 'Echo', 'https://cdn.openai.com/API/docs/audio/echo.wav'),
            new Voice('fable', 'Fable', 'https://cdn.openai.com/API/docs/audio/fable.wav'),
            new Voice('onyx', 'Onyx', 'https://cdn.openai.com/API/docs/audio/onyx.wav'),
            new Voice('nova', 'Nova', 'https://cdn.openai.com/API/docs/audio/nova.wav'),
            new Voice('shimmer', 'Shimmer', 'https://cdn.openai.com/API/docs/audio/shimmer.wav'),
        ]
    }
}